...
With this bidirectional perspective, I aim to publish in both leading networking venues (INFOCOM, MobiCom, ICC, GLOBECOM) emphasizing system performance and deployability, and top machine learning conferences (ICML, ICLR, NeurIPS) focusing on fundamental learning theory under network constraints. Ultimately, I envision my research bridging theoretical ML advances and practical wireless systems, contributing algorithms that are both theoretically grounded and deployable in real-world networks.